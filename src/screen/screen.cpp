...
void *screen_task(void *arg)
{
    ...
    while (1)
    {
      ...
      Screen.printline(_cf_msg.timestamp, _cf_msg.roll, _cf_msg.pitch, _cf_msg.yaw, "roll", "pitch","yaw");
      Screen.printline(_gyro_msg.timestamp, _gyro_msg.gyro[0], _gyro_msg.gyro[1], _gyro_msg.gyro[2], "gyro x", "gyro y","gyro z");
      Screen.printline(_accel_msg.timestamp, _accel_msg.accel[0], _accel_msg.accel[1], _accel_msg.accel[2], "accel x", "accel y","accel z");
      Screen.printline(_mag_msg.timestamp, _mag_msg.mag[0], _mag_msg.mag[1], _mag_msg.mag[2], "mag x", "mag y","mag z");
      Screen.printline(_gps_msg.timestamp, _gps_msg.hacc, _gps_msg.vacc, _gps_msg.sacc, "hacc", "vacc", "sacc");
      Screen.printline(_gps_msg.timestamp, _gps_msg.fixType, _gps_msg.numSV, _gps_msg.updated, "fixType", "numSV", "Updated");
      Screen.endscreen();
    }
    return 0;
}
