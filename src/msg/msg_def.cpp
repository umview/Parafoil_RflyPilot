...
ringbuffer_typedef<thread_msg_typedef> ctrl_thread_msg(10,"ctrl_thread",LOG_DIV_1);
ringbuffer_typedef<thread_msg_typedef> imu_thread_msg(10,"imu_thread",LOG_DIV_1);
ringbuffer_typedef<thread_msg_typedef> attest_thread_msg(10,"attest_thread",LOG_DIV_1);
