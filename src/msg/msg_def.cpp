...
ringbuffer_typedef<cf_output_typedef> cf_output_msg(CF_OUTPUT_N, "cf_output", LOG_DIV_5);
ringbuffer_typedef<lpe_output_typedef> lpe_output_msg(LPE_OUTPUT_N, "lpe_output", LOG_DIV_5);
...
ringbuffer_typedef<accel_typedef> accel_msg(ACCEL_N, "accel",LOG_DIV_5);
ringbuffer_typedef<gyro_raw_typedef> gyro_raw_msg(GYRO_RAW_N,"gyro_raw",LOG_DISABLE);
ringbuffer_typedef<gyro_typedef> gyro_msg(GYRO_N, "gyro", LOG_DIV_5);

ringbuffer_typedef<baro_typedef> baro_msg(BARO_N, "baro", LOG_DIV_1);
ringbuffer_typedef<gps_msg_typedef> gps_msg(GPS_N, "gps", LOG_DIV_1);
ringbuffer_typedef<sbus_packet_t> rc_input_msg(SBUS_N, "rc_input", LOG_DIV_5);
ringbuffer_typedef<actuator_output_typedef> actuator_output_msg(ACTUATOR_OUTPUT_N, "actuator_output", LOG_DIV_1);
ringbuffer_typedef<actuator_output_typedef> aux_actuator_output_msg(ACTUATOR_OUTPUT_N, "aux_actuator_output", LOG_DIV_1);

ringbuffer_typedef<rflysim3d_output_typedef> rflysim3d_output_msg(1,"rflysim3d",LOG_DISABLE);

ringbuffer_typedef<rflypilot_config_typedef> rflypilot_config_msg(1,"config",LOG_DIV_1);
